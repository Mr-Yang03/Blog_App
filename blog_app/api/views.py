"""
API Views - Centralized REST API views for all apps
"""
...
# Import serializers from api app
...
def search_posts(request):
    ...
    GET /api/search/?q=keyword&category=1&tag=2&author=username
    """
